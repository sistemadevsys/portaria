...
#End Region
    ...
    Private CamFrameRate As Integer = 50
    Private OutputHeight As Integer = 394 '240
    Private OutputWidth As Integer = 330 '360
    Public Sub resetCam()
        ...
        If iRunning Then
            ...
            If setCam() = False Then
                MessageBox.Show("Falha de conexão com a câmera", "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                alterado = 1000
            End If
        End If
    ...
    Public Sub initCam(ByVal parentH As Integer)
        ...
        If Me.iRunning = True Then
            MessageBox.Show("A câmera já está em execução", "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        Else
    ...
    Public Function copyFrame(ByVal src As PictureBox, ByVal rect As RectangleF) As Bitmap
        If iRunning Then
            ...
            Dim srcPng As New Bitmap(src.Width, src.Height, srcPic)
            Dim srcMem As Graphics = Graphics.FromImage(srcPng)
            ...
            copyFrame = CType(srcPng.Clone(), Bitmap)
            ...
            srcMem.Dispose()
        Else
            MessageBox.Show("Câmera não esta em execução!", "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Function
