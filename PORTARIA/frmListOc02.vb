...
Public Class frmListOc02
    ...
    Dim VEI003, VEI004, iVEI002 As New TextBox
    Dim PLACA As New TextBox
    Dim pop, popAs As Integer
    Private Sub BEEP_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Return) Then
            e.Handled = True
        End If
    End Sub
    Private Sub FrmListOc02_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        gatilho = 0
        lvAcp.Visible = False
    ...
    Private Sub carregalist(arg)
        Select Case arg
            Case 0
                ...
                conexao.Open()
                Dim cmd As MySqlCommand = New MySqlCommand("SELECT a.CON01,a.CON02,a.CON006,a.GAR002,b.CADP003,b.CADP023,b.CADP026,b.CADP027 FROM prt_acesscon as a inner join prt_cadpro as b on (a.CADP001 = b.CADP001) where a.CADP002 = '" & CADP002.Text & "' AND a.CON17 = '1'", conexao)
                ...
                Do While leitor.Read()
                    ...
                    item.SubItems.Add(leitor("GAR002").ToString)        ' 8 GARAGEM
    ...
    Private Sub LvDados_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvDados.SelectedIndexChanged
        Try
            If lvDados.SelectedItems.Count > 0 Then
                ...
                Me.GAR002.Text = Me.lvDados.SelectedItems(0).SubItems(8).Text

                tarja.Text = " " & Trim(GAR002.Text) & "   -   " & "     UNIDADE: " & Trim(Repositorio.CADP002.Text)
...
#Region "FUNÇÕES"
    ...
    Private Sub BtnEncerra_Click(sender As Object, e As EventArgs) Handles btnEncerra.Click
        ...
        If (MetroFramework.MetroMessageBox.Show(Me, " O registro será encerrado. Confirma ?  ", "" & legenda & "", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) = MsgBoxResult.Yes Then
            ...
            MetroFramework.MetroMessageBox.Show(Me, " O Registro foi baixado com sucesso" & "   Gatilho:" & gatilho, "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Information)
