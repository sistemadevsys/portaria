...
#Region "VARIÁVEIS"
    ...
    Dim FUN024, IMG006, EMP002, EMP003 As New TextBox
...
#Region "START DO FORMULÁRIO"
    ...
    Private Sub frmfrmEmpresaFun_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel3.Visible = True
        IMG006.Text = "EMP"
        EMP002.Text = Repositorio.EMP002.Text
        EMP003.Text = Repositorio.EMP003.Text
    ...
    Private Sub filtrar()
        Select Case filtro
            Case 99 ' TODOS OS REGISTROS
                sql = "SELECT FUN002,FUN003 from prt_cadfun WHERE FUN026 = '0' and EMP002 = '" & EMP002.Text & "' order by FUN003"
            Case 1 ' FILTRA PELO NOME DO PROPRIETÁRIO
                sql = "SELECT FUN002,FUN003 FROM prt_cadfun WHERE FUN003 like '" & chave & "%' and FUN026 = '0' and EMP002 = '" & EMP002.Text & "' order by FUN003"
        End Select
    End Sub
    ...
    Private Sub buscadados(arg)
        Select Case arg
            Case 0
                ...
                While leitor.Read()
                    FUN004.Text = IIf(Convert.IsDBNull(leitor("FUN004")) = True, "", leitor("FUN004")) ' SETOR
            ...
            Case 1
                ...
                Dim sql = "select * from prt_cpres order by SET02"
                Dim adptr As New MySqlDataAdapter(sql, conexao)
                adptr.Fill(ds, "prt_cpres")
                dt = ds.Tables(0)
                FUN004.Items.Clear()
                For Each dr In dt.Rows
                    FUN004.Items.Add(dr.Item("SET02"))
                Next
        End Select
    End Sub
#End Region
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        If Valida > 0 Then
            If acao = "NOVO" Then
                ...
                sql = "insert into prt_cadfun(FUN002,FUN003,FUN004,FUN008,FUN009,FUN010,FUN011,FUN012,FUN015,FUN016,FUN017,FUN018,FUN019,FUN020,FUN021,FUN022,FUN023,FUN024,FUN025,FUN026,FUN028,EMP002)values('" & FUN002.Text & "','" & FUN003.Text & "','" & FUN004.Text & "','" & FUN008.Text & "','" & FUN009.Text & "','" & FUN010.Text & "','" & FUN011.Text & "','" & FUN012.Text & "','" & FUN015.Text & "','" & FUN016.Text & "','" & FUN017.Text & "','" & FUN018.Text & "','" & FUN019.Text & "','" & FUN020.Text & "','" & FUN021.Text & "','ATIVO','0','REGISTRO','" & Format(FUN025.Value, "yyyy-MM-dd") & "','0','EMP','" & EMP002.Text & "')"
            Else
                texto = "Alteração efetuada com sucesso"
                sql = "update prt_cadfun set  FUN003 = '" & FUN003.Text & "', FUN004 = '" & FUN004.Text & "', FUN008 = '" & FUN008.Text & "', FUN009 = '" & FUN009.Text & "', FUN010 = '" & FUN010.Text & "', FUN011 = '" & FUN011.Text & "', FUN012 = '" & FUN012.Text & "', FUN015 = '" & FUN015.Text & "', FUN016 = '" & FUN016.Text & "', FUN017 = '" & FUN017.Text & "', FUN018 = '" & FUN018.Text & "', FUN019 = '" & FUN019.Text & "', FUN020 = '" & FUN020.Text & "', FUN021 = '" & FUN021.Text & "' WHERE FUN002 = '" & FUN002.Text & "'"
            End If
            Try
...
#Region "ENTER"
    ...
    Private Sub btnTrans_Click(sender As Object, e As EventArgs) Handles btnTrans.Click
        If pop > 0 Then
            frmEmpresaTrans.EMP002.Text = EMP002.Text
            frmEmpresaTrans.EMP003.Text = EMP003.Text
