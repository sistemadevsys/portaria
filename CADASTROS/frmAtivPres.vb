...
#Region "START DO FORMULÁRIO"
    ...
    Private Sub frmLocalizacao_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        nome.Clear()
        nome.Focus()
        tabela = "prt_cpres" ' NOME DA TABELA
        campo = "SET02"      ' CAMPO DA TABELA
    End Sub
#End Region
...
#Region "FUNÇÕES"
    ...
    Private Sub nome_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles nome.KeyDown
        ...
        If KeyCode = System.Windows.Forms.Keys.Return Then
            If nome.TextLength = 0 Then
                MetroFramework.MetroMessageBox.Show(Me, " É necessário informar a Descrição! ", "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            Else
                ...
                If retorno = Nothing Then
                    btnsave.Focus()
                Else
                    MetroFramework.MetroMessageBox.Show(Me, " Descrição informada já existe ! ", "" & legenda & "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
