    ...
    Private Sub filtrar()
        Select Case filtro
            Case 99 ' TODOS OS REGISTROS
                sql = "SELECT FUN002,FUN003 from prt_cadfun WHERE FUN026 = '0' and FUN028 = 'PRE' order by FUN003"
            Case 1 ' FILTRA PELO NOME DO PROPRIETÁRIO
                sql = "SELECT FUN002,FUN003 FROM prt_cadfun WHERE FUN003 like '" & chave & "%' and FUN026 = '0' and FUN028 = 'PRE' order by FUN003"
        End Select
    End Sub
...
#Region "BOTÕES"
    ...
    Private Sub btnTransf_Click(sender As Object, e As EventArgs) Handles btnTransf.Click
        frmEmpresaTrans.EMP002.Text = "100001"
        frmEmpresaTrans.EMP003.Text = "PRESTADORES DE SERVIÇOS AVULSOS - SEM REGISTRO EM CTPS"
        Repositorio.FUN002.Text = FUN002.Text
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        If Valida > 0 Then
            If acao = "NOVO" Then
                ...
                sql = "insert into prt_cadfun(FUN002,FUN003,FUN004,FUN006,FUN008,FUN009,FUN010,FUN011,FUN012,FUN015,FUN016,FUN017,FUN018,FUN019,FUN020,FUN021,FUN022,FUN023,FUN024,FUN025,FUN026,FUN028,EMP002)values('" & FUN002.Text & "','" & FUN003.Text & "','" & FUN004.Text & "','" & Format(FUN006.Value, "yyyy-MM-dd") & "','" & FUN008.Text & "','" & FUN009.Text & "','" & FUN010.Text & "','" & FUN011.Text & "','" & FUN012.Text & "','" & FUN015.Text & "','" & FUN016.Text & "','" & FUN017.Text & "','" & FUN018.Text & "','" & FUN019.Text & "','" & FUN020.Text & "','" & FUN021.Text & "','ATIVO','0','REGISTRO','" & Format(FUN025.Value, "yyyy-MM-dd") & "','0','PRE','100001')"
            Else
                texto = "Alteração efetuada com sucesso"
                sql = "update prt_cadfun set  FUN003 = '" & FUN003.Text & "', FUN004 = '" & FUN004.Text & "', FUN006 = '" & Format(FUN006.Value, "yyyy-MM-dd") & "', FUN008 = '" & FUN008.Text & "', FUN009 = '" & FUN009.Text & "', FUN010 = '" & FUN010.Text & "', FUN011 = '" & FUN011.Text & "', FUN012 = '" & FUN012.Text & "', FUN015 = '" & FUN015.Text & "', FUN016 = '" & FUN016.Text & "', FUN017 = '" & FUN017.Text & "', FUN018 = '" & FUN018.Text & "', FUN019 = '" & FUN019.Text & "', FUN020 = '" & FUN020.Text & "', FUN021 = '" & FUN021.Text & "' WHERE FUN002 = '" & FUN002.Text & "'"
            End If
            Try
