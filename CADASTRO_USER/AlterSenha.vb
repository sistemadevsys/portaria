...
Public Class AlterSenha
    Dim USU001 As New TextBox
    Dim SenhaAlterada As New TextBox
    ...
    Private Sub AlterSenha_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
...
#Region "BEEP DO ENTER"
    ...
    End Sub
#End Region
    Private Sub AlterSenha_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        USU002.Text = Login.lvdados.Text
        redondo(0, 0, Panel3, 20, 20) ' arredonda as bordas do painel onde fica os textbox
        redondo(0, 0, tbcp120, 30, 30) ' arredonda as bordas do texto de identificação superior
    ...
    Private Sub tbsenha_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles tbSenha.KeyDown
        ...
        If KeyCode = System.Windows.Forms.Keys.Return Then
            SenhaAlterada.Text = geraHash(tbSenha.Text)
            If SenhaAlterada.Text <> iSenha Then
    ...
    Private Sub testacampo()
        ...
        Else
            SenhaAlterada.Text = ""
            SenhaAlterada.Text = geraHash(tbconfirma.Text)
            btnF5.Visible = True
            btnF5.Focus()
        End If
    End Sub
    ...
    Private Sub gravar(arg)
        Select Case arg
            Case 0
                ...
                Dim s1 As String = "update usuarios set USU004 ='" & SenhaAlterada.Text & "', USU009 = '0' WHERE USU001 ='" & iCodUser & "' and USU008 = '" & sistema & "'"
                Dim cmnd As New MySqlCommand(s1, conexao)
                conexao.Open()
                cmnd.ExecuteNonQuery()
                iSenha = SenhaAlterada.Text
                conexao.Close()
            Case 1
